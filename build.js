    ...
    _ensureTemplatized: function() {
      if (!this.ctor) {
        ...
        if (this._userTemplate) {
          ...
          console.warn('t-simple-list requires a template to be provided in light-dom');
        }
      }
    },
...
(function () {
        ...
        generateList: function() {
            ...
            _applyFilters: function (event) {
                ...
                if (event.detail.filters && event.detail.filters.length)
...
Polymer({
    ...
    properties: {
        ...
        /*Pass true to change the layout to shift the pricing on the left.*/
        priceLeft: {
            type: Boolean,
            value: false,
            reflectToAttribute: true
        ...
        /*The value will pass a default airline image when there is no image/ to handle mixed airline scenario*/
        defaultLogo: {
            type: String
        }
    },
